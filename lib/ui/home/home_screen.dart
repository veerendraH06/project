                      ...
                      children: <Widget>[
                        ...
                        Container(
                          ...
                          child: DatePicker(
                            ...
                            initialSelectedDate: DateTime.now().subtract(Duration(days: 3)),
                                        ...
                                        BlocBuilder<PatientBloc,PatientAppointmentBlocState>(
                                            builder: (context, state) {
                                              ...
                                              if (state.keyword != null &&
                                                ...
                                                filteredUsers = users.where((u) => (u.name.toLowerCase().contains(state.keyword.toLowerCase()) || u.email.toLowerCase().contains(state.keyword.toLowerCase())))
                                                    .toList();
                                              } else {
                                                filteredUsers = users;
                                              }
            ...
            title: ListTile(
              ...
              onPressed: (){
                  return showDialog(
                    ...
                    builder: (ctx) =>
                        AlertDialog(
                          title: Text("Select a filter",style: TextStyle(),),
                          actions: <Widget>[
                            Dictation(),
                            Patients(),
                            Container(
